const char bmtrace_help[] = {
  ...
  " of a string. This wildcard is useful for matching a word delimiter.\n"
  "\n"
  "If the filter text starts with a not sign ('\xc2\xac'), it is an inverted filter: a trace\n"
  "message passes the filter if it does not contain the text that follows the '\xc2\xac'.\n"
  "The tilde ('~') is equivalent to the '\xc2\xac', since not every keyboard layout provides\n"
